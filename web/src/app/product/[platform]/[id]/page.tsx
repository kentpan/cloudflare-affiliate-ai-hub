...
import { listDates, readJson, dataPath } from "@/lib/affiliate/data-writer";
...
export async function generateMetadata({ params }: PageProps) {
  ...
  const product = findProduct(platform as Platform, id);
...
function findProduct(platform: Platform, id: string): PickedProduct | null {
